		...
		<div className="flex size-full flex-col items-center justify-center space-y-4">
			<div className="flex w-full flex-col items-center space-y-4">
				<div className="relative flex items-center justify-center">
					<Image className="h-auto w-36 select-none rounded-full lg:w-40" src={"/raniza/profile.webp"} width={150} height={150} alt={Title + " - Logo"} />
					...
					<Link href="/" className="group absolute -left-24 lg:-left-28">
						<div className="button-transition rounded-full group-hover:scale-105 group-hover:shadow-[0px_0px_15px_1px_#09de79]">
							<Image className="h-auto w-16 select-none rounded-full lg:w-20" src={"/home/profile.webp"} width={100} height={100} alt={Title_Alanalarana + " - Logo"} />
						</div>
					</Link>
				</div>
