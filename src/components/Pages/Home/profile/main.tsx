		...
		<div className="flex size-full flex-col items-center justify-center gap-4">
			<div className="flex w-full flex-col items-center gap-4">
				<div className="relative flex items-center justify-center">
					<Image className="size-36 select-none rounded-full lg:size-40" src={"/assets/pages/home/profile.webp"} width={150} height={150} alt={Title + " - Logo"} />
					...
					<Link href="/raniza" className="group absolute -right-24 lg:-right-28">
						<div className="button-transition rounded-full group-hover:scale-105 group-hover:shadow-[0px_0px_15px_1px_#09de79]">
							<Image className="h-auto w-16 select-none rounded-full lg:w-20" src={"/assets/pages/raniza/profile.webp"} width={100} height={100} alt={Title_Raniza + " - Logo"} />
						</div>
					</Link>
				</div>
